...
export default class extends AbstractView{
    ...
    async getPage(){
       return `
       <h2 class="title" translateKey="Port1">Choose Language to show text/ Wybierz język aby wywyświetlić tekst/ Velg språk for å vise tekst</h2>
       <div class="odPics">
       ...
       <p class="odText1" translateKey="odText6"></p>
   `;
    }
}