...
export default class extends AbstractView{
    ...
    async getPage(){
       return `
       <h2 class="title" translateKey="About">Choose Language to show text/ Wybierz język aby wywyświetlić tekst/ Velg språk for å vise tekst</h2>
       <div class="myPic" >
       ...
       <p class="aboutTxt1" translateKey="AboutText6"></p> 
   `;
    }
}